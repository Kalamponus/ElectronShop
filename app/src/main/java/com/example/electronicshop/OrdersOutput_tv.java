...
public class OrdersOutput_tv extends AppCompatActivity implements View.OnClickListener {
    DBHelper dbHelper;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_orderslist_tv);
    ...
    public void onClick(View v) {
        if(v.getTag() == "delete") {
            ...
            Intent intent = new Intent(this, MainActivity_tv.class);
