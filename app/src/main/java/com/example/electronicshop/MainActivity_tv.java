...
public class MainActivity_tv extends AppCompatActivity implements View.OnClickListener {

    Button btnAdd, btnOrders, btnShop;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_products_tv);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btnAdd:
                ...
                break;
            case R.id.btnOrders:
                Intent intent = new Intent(this, OrdersOutput_tv.class);
                startActivity(intent);
                break;
            case R.id.btnShop:
                Intent intentShop = new Intent(this, Shop_tv.class);
