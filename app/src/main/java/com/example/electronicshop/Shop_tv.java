...
public class Shop_tv extends AppCompatActivity implements View.OnClickListener{
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btnAdmin:
                Intent intent = new Intent(this, AdminLogIn_tv.class);
                startActivity(intent);
                break;
            case R.id.btnOrder:
                Intent intentOrder = new Intent(this, OrderTaker_tv.class);
